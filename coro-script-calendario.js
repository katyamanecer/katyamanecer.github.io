 ...
 * Modificado por Katy Mar.
 * http://shaddaikawaii.blogspot.mx/
...
var confJson = {day:[], month:[], year:[], dateText:[], titleText:[], href:[]},
	...
	confStyle = {anchor:'text-decoration:none;color:#8cdee1;cursor:default;', border:'border:1px solid #fc7eb6;', family:'verdana,arial;', size:11, bgover:'#eb9aee'},
	confHost = {drive:'https://www.googledrive.com/host/0B5G3cbs08P16fnc3cDVkdllDTDNONkdrNHM1b2NUWXpsLWxKSmQwZHljQWVxUFJWVzBKODA/'},
	confSource = {right:confHost.drive+'right.gif', left:confHost.drive+'left.gif', drop:confHost.drive+'drop.gif'}
...
function createCalendar(json){
	...
	if(confJson.dateText.length){
		...
		styleArrow = "border:1px solid #6cc2f0;cursor:pointer;padding:1;line-height:8px;";
		styleDate = "font-family:"+confStyle.family+"font-weight:bold;font-size:"+confStyle.size+"px;color:#313131;border:1px solid #6cc2f0;cursor:pointer;"
...
function overBox(obj){
	obj.style.backgroundColor = "#6cc2f0";
}
function outBox(obj){
